  ...
  const activities = [
    {
      ...
      description: "Modern Villa in Downtown",
      time: "2 hours ago",
      icon: Home,
      color: "blue",
    },
    ...
    },
    {
      ...
      type: "sale",
      title: "Property sold",
      description: "Luxury Apartment - $1.2M",
      time: "6 hours ago",
      icon: DollarSign,
      color: "yellow",
    },
    {
      ...
      description: "48 new views today",
      time: "8 hours ago",
      icon: Eye,
      color: "red",
    },
    {
      ...
      type: "message",
      title: "Team Reminder",
      description: "Don't forget to review client feedback by 5 PM.",
      time: "10 minutes ago",
      icon: MessageCircle,
      color: "purple",
    },
